...
#                if((iloc >=0)&(iloc<18)):
                if(stm_cue[iloc,0] ==1 ):
                    ...
                    if(stm_type == 'brightened'):
                        particular_stimulus = 1.0*(stimuli_collection[stm_type])
                    else:
...
(mEbin_ra,mIbin_ra,xEbin_ra,xIbin_ra,VEavgbin_ra,VIavgbin_ra,VEstdbin_ra,VIstdbin_ra,nEbin_ra,nIbin_ra,GaussApproxEbin_ra,GaussApproxIbin_ra) = simulation.update(t0=t0, dt=dt, tf=tf)
#return self.mEbin_ra,self.mIbin_ra,self.xEbin_ra,self.xIbin_ra,self.VEavgbin_ra,self.VIavgbin_ra,self.VEstdbin_ra,self.VIstdbin_ra,self.nEbin_ra,self.nIbin_ra
...
scio.savemat(filename,{'mEbin_ra':mEbin_ra,'mIbin_ra':mIbin_ra,'xEbin_ra':xEbin_ra,'xIbin_ra':xIbin_ra,\
                       ...
                       'nEbin_ra':nEbin_ra,'nIbin_ra':nIbin_ra,'GaussApproxE':GaussApproxEbin_ra,'GaussApproxI':GaussApproxIbin_ra}) 
